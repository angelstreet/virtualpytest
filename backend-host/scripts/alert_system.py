...
# Add backend-host and shared paths for microservices structure
current_dir = os.path.dirname(__file__)  # backend-host/scripts/
backend_host_dir = os.path.dirname(current_dir)  # backend-host/
