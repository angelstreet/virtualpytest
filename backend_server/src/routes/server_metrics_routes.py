...
from shared.src.lib.config.supabase.navigation_metrics_db import (
    get_tree_metrics,
    get_action_execution_history,
    get_verification_execution_history
)
from shared.src.lib.config.supabase.navigation_trees_db import get_tree_nodes, get_tree_edges
...
def get_tree_metrics_api(tree_id):
    ...
    try:
        ...
        from shared.src.lib.config.supabase.navigation_trees_db import get_complete_tree_hierarchy
...
def get_edge_direction_metrics_api(edge_id, action_set_id, tree_id):
    ...
    try:
        from shared.src.lib.config.supabase.navigation_metrics_db import get_edge_direction_metrics
