...
def get_tree_by_userinterface_id(userinterface_id):
    ...
    try:
        ...
        if success and trees:
            ...
            try:
                from shared.lib.utils.navigation_cache import get_cached_tree_data
                ...
                if resolved_tree_data:
                    ...
                    from shared.lib.supabase.execution_results_db import get_tree_metrics
...
def restore_version_direct():
    ...
    try:
        ...
        from shared.lib.supabase.client import get_supabase
        ...
        if restore_result.data:
            ...
            from shared.lib.supabase.navigation_trees_db import get_next_version_number
...
def update_tree_endpoint(tree_id):
    ...
    try:
        ...
        from shared.lib.supabase.navigation_trees_db import update_tree
...
def create_sub_tree_endpoint():
    ...
    try:
        ...
        from shared.lib.supabase.navigation_trees_db import create_sub_tree, update_node_sub_tree_reference
...
def get_breadcrumb_endpoint(tree_id):
    ...
    try:
        ...
        from shared.lib.supabase.navigation_trees_db import get_tree_breadcrumb
...
def get_node_sub_trees_endpoint(tree_id, node_id):
    ...
    try:
        ...
        from shared.lib.supabase.navigation_trees_db import get_node_sub_trees
...
def update_node_sub_tree_reference_endpoint():
    ...
    try:
        ...
        from shared.lib.supabase.navigation_trees_db import update_node_sub_tree_reference
