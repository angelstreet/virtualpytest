...
def get_navigation_stats(tree_id):
    ...
    try:
        ...
        try:
            ...
            from shared.lib.utils.navigation_graph import validate_graph, get_entry_points
...
def get_cache_stats():
    ...
    try:
        ...
        try:
            from shared.lib.utils.navigation_cache import get_cache_stats as get_cache_stats_internal
