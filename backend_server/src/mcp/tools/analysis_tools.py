...
class AnalysisTools:
    ...
    # DEPRECATED: fetch_execution_report removed
    # Reports are now always pre-fetched using backend_server.src.lib.report_fetcher
    # This saves LLM tokens and improves performance
