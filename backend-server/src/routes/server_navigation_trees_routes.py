...
from supabase.userinterface_db import get_all_userinterfaces
...
def get_tree_by_userinterface_id(userinterface_id):
    ...
    try:
        ...
        if success and trees:
            ...
            try:
                from utils.navigation_cache import get_cached_tree_data
                ...
                if not resolved_tree_data:
                    ...
                    from supabase.userinterface_db import get_userinterface
                ...
                if resolved_tree_data:
                    ...
                    from supabase.execution_results_db import get_tree_metrics
...
def restore_version():
    ...
    try:
        ...
        if success:
            ...
            from utils.navigation_cache import invalidate_cache
...
def restore_version_direct():
    ...
    try:
        ...
        if restore_result.data:
            ...
            from supabase.navigation_trees_db import get_next_version_number
...
def update_tree_endpoint(tree_id):
    ...
    try:
        ...
        from supabase.navigation_trees_db import update_tree
        ...
        if updated_tree:
            ...
            from supabase.navigation_trees_db import get_navigation_tree
...
def create_sub_tree_endpoint():
    ...
    try:
        ...
        from supabase.navigation_trees_db import create_sub_tree, update_node_sub_tree_reference
...
def get_breadcrumb_endpoint(tree_id):
    ...
    try:
        ...
        from supabase.navigation_trees_db import get_tree_breadcrumb
...
def get_node_sub_trees_endpoint(tree_id, node_id):
    ...
    try:
        ...
        from supabase.navigation_trees_db import get_node_sub_trees
...
def update_node_sub_tree_reference_endpoint():
    ...
    try:
        ...
        from supabase.navigation_trees_db import update_node_sub_tree_reference
