...
# - Metadata: 300 × 1KB = 0.3MB (individual JSONs → progressive grouping 1min→10min)
# - Transcripts: 24 × 50KB = 1.2MB (hourly transcript files, KEPT IN HOT - light data)
# Total: ~84.5MB per device ✅ (42% of 200MB budget, high quality preserved)
#
HOT_LIMITS = {
    ...
    'metadata': 300,      # Individual JSONs → progressive grouping (1min→10min)
}
