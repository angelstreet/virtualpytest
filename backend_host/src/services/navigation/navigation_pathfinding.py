...
from lib.utils.navigation_exceptions import UnifiedCacheError, PathfindingError
...
def find_shortest_path_unified(root_tree_id: str, target_node_id: str, team_id: str, start_node_id: str = None) -> Optional[List[Dict]]:
    ...
    from lib.utils.navigation_cache import get_cached_unified_graph, get_node_tree_location, get_tree_hierarchy_metadata
    from lib.utils.navigation_graph import get_entry_points, get_node_info
...
def _create_validation_step(G, from_node: str, to_node: str, edge_data: Dict, step_number: int, step_type: str, current_position: str = None, tree_id: str = None, team_id: str = None) -> Tuple[List[Dict], Optional[Dict]]:
    ...
    """
    from lib.utils.navigation_graph import get_node_info
