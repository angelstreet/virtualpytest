-- 016_folders_and_tags.sql
-- Unified Test Organization: Folders and Tags for Scripts and Testcases
...
-- Clean implementation with no auto-organization or fallbacks
...
-- ================================================
DROP TABLE IF EXISTS executable_tags CASCADE;
...
-- Indexes
CREATE INDEX idx_exec_tags_lookup ON executable_tags(executable_type, executable_id);
CREATE INDEX idx_exec_tags_tag ON executable_tags(tag_id);
