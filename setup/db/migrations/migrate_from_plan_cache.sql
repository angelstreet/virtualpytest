-- Create ai_graph_cache table
-- Run this in your Supabase SQL Editor

-- This is the clean implementation from schema/009_ai_graph_cache.sql
-- Drop existing table if it exists (for clean recreation)
DROP TABLE IF EXISTS ai_graph_cache CASCADE;
DROP TABLE IF EXISTS ai_plan_generation CASCADE; -- Remove old naming if it exists
